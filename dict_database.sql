...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 19, 2024 at 01:44 AM
...
INSERT INTO `dict_diagnostic_examinees` (`id`, `label`, `full_name`, `last_name`, `first_name`, `middle_name`, `suffix`, `sex`, `profession_or_student`, `course`, `school`, `company_name`, `position`, `examination_date`, `exam_venue`, `status`) VALUES
...
(47, 'DICT Diagnostic Examinee', 'Angulo, Renato Jr. D.', 'Angulo', 'Renato', 'D.', 'JR', 'Male', 'Student', 'BS in Information Technology', 'Saint Francis Xavier College', 'N/A', 'Student', 'April 12, 2023', 'DTC San Francisco, Agusan del Sur', ''),
...
INSERT INTO `ict_edp_examinees` (`id`, `label`, `full_name`, `last_name`, `first_name`, `middle_name`, `suffix`, `sex`, `profession_or_student`, `course`, `school`, `company_name`, `position`, `examination_date`, `exam_venue`, `status`) VALUES
...
INSERT INTO `users_assessment_examinees` (`id`, `label`, `full_name`, `last_name`, `first_name`, `middle_name`, `suffix`, `sex`, `profession_or_student`, `course`, `school`, `company_name`, `position`, `examination_date`, `exam_venue`, `status`) VALUES
...
(37, 'Users Assessment Examinee', 'Leo A. Morgadez', 'Morgadez', 'Leo', 'A. ', '', 'M', 'Professional', 'N/A', 'N/A', 'undefined', 'undefined', 'undefined', 'undefined', '');
